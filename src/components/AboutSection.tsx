          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-3 space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Nosso fundador, o empreendedor brasileiro <span className="font-semibold text-foreground">Sidnei Nunes</span>, trouxe uma visão inovadora após 10 anos de Austrália, onde completou um Mestrado em Análise de Negócios. Ele notou dois problemas cruciais no mercado:
                </p>

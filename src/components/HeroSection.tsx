      ...
      <div className="relative z-10 flex-1 flex items-center pt-24 pb-32">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl">
            {/* Main Title */}
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-8 animate-fade-up delay-100 drop-shadow-lg text-left">
            ...
            {/* Subtitle */}
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mb-12 leading-relaxed animate-fade-up delay-200 drop-shadow-md text-left">
